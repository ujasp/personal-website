...
import { FiArrowRight, FiChevronLeft, FiChevronRight, FiClock } from 'react-icons/fi';
import './Blog.css';
    ...
    const customArticles = [
        {
            ...
            description: "Breaking down whether enterprises should adopt headless or native semantic layers, and how the right architecture drives higher data activation across AI products.",
        ...
        },
        {
            ...
            link: "/blog/ai-product-strategy-2025",
        ...
        },
        {
            ...
            link: "/blog/ai-project-management-2025",
                                ...
                                {post.external ? (
                                    <a href={post.link} target="_blank" rel="noopener noreferrer" className="article-card-link">
                                        ...
                                        <div className="article-content">
                                            ...
                                            <Link to={post.link} className="article-title">{post.title}</Link>
                                    ...
                                    <Link to={`/blog/${post.guid}`} className="article-card-link">
                                        ...
                                        <div className="article-content">
                                            <span className="article-category">{post.category}</span>
                                            <Link to={`/blog/${post.guid}`} className="article-title">{post.title}</Link>
                                            <div className="article-footer">
                                                <div className="article-meta">
                                                    <span className="article-date">
                                                        {new Date(post.pubDate).toLocaleDateString('en-US', {
