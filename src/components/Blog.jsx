    ...
    const customArticles = [
        {
            ...
            description: "Breaking down when enterprises should choose headless or native semantic layers, and how the right architecture can unlock higher data activation rates across AI products.",
